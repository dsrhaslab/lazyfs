...
#===============================================================================
#   DESCRIPTION: This script tests bug #8 of ZooKeeper v3.4.8 and v3.7.1
#       
#      - Error           (v3.4.8, v3.7.1) CRC check failed
#      - Time            6 seconds
#
#        AUTHOR: Maria Ramos,
#      REVISION: 1 Apr 2024
...
for i in "${servers[@]}"
do 
    . "$DIR/zookeeper-8-vars.sh" $i #File to configure with paths important for the tests
...
. "$DIR/zookeeper-8-vars.sh" $server_fault
