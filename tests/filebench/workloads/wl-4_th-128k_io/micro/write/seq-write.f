...
set $NR_THREADS=4
set $LAZYFS_FIFO="/tmp/lfs.fb2.seq-write.131072.fifo"
...
define process name="process1", instances=1
{
    thread name="thread1", memsize=10m, instances=1
    {
        ...
        flowop write name="write1", fd=1, iosize=$IO_SIZE, iters=$NR_ITERATIONS
    ...
    thread name="thread2", memsize=10m, instances=1
    {
        ...
        flowop write name="write2", fd=1, iosize=$IO_SIZE, iters=$NR_ITERATIONS
    ...
    thread name="thread3", memsize=10m, instances=1
    {
        ...
        flowop write name="write3", fd=1, iosize=$IO_SIZE, iters=$NR_ITERATIONS
    ...
    thread name="thread4", memsize=10m, instances=1
    {
        ...
        flowop write name="write4", fd=1, iosize=$IO_SIZE, iters=$NR_ITERATIONS
