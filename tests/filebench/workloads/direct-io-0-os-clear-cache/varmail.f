...
define fileset name=bigfileset,path=$WORKLOAD_PATH,size=$filesize,entries=$nfiles,dirwidth=$meandirwidth,prealloc=80
...
system "sync /mnt/test-fs/passthrough/fb-workload"
